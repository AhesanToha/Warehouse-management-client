...
const Blogs = () => {
  return (
    <div>
      <div className="h-[10vh] flex items-center justify-center stockheader">
        <h1 className="md:text-3xl text-2xl font-bold text-gray-400">BLOGS</h1>
      </div>
      <div className="text-left py-6 mb-32 md:w-3/4 mx-auto p-2">
        <div className="qna my-2 p-1 shadow-sm">
          <h1 className="text-xl font-bold text-red-500 my-2">
          ...
          <h2 className="ml-1">
            ...
            <br />
            c ) Javascript is capable enough to add HTML and play with the DOM.{" "}
            <br />
          </h2>
        </div>
        ...
        <div className="qna my-2 p-1 shadow-sm">
          ...
          <h2 className="ml-1">
            ...
            Javascript programming language .So, if i want to write some kind of
            stand-alone program or server in Javascript, then i can use nodejs
            for it. <br />
            MongoDB- <br />
